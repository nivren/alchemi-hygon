...
__global__ void cell_key_build_kernel(
...
#pragma unroll
  ...
  cell_keys[atom] = coordinate[0] + dimensions[0] *
...
void cell_key_build_hip(
  ...
  AT_DISPATCH_FLOATING_TYPES(positions.scalar_type(), "cell_key_build_hip", [&] {
    cell_key_build_kernel<scalar_t><<<blocks, threads, 0, stream>>>(
