...
"""Backend-neutral operation dispatch through registered executors."""
...
def _legacy_unavailable(*args: Any, **kwargs: Any) -> Any:
    """Reject framework-owned legacy execution at the ops package boundary."""
    del args, kwargs
    raise BackendUnavailableError(
        "the ops dispatcher does not execute framework-owned legacy Warp; "
        "use the framework legacy entry point"
    )
...
def dispatch_neighbor_list(
    ...
    **kwargs: object,
    ...
    """Dispatch neighbor construction through the selected executor."""
    features = {
...
def dispatch_lj_energy_forces(
    ...
    *,
    ...
    """Dispatch LJ energy/force evaluation through the selected executor."""
    if selection is None:
        features = {
