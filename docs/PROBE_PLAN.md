...
P04 自定义算子的 fake/meta、opcheck、gradcheck/gradgradcheck，P05 periodic LJ/NVE 闭环、P07 两卡 LJ ownership/pair 守恒尚待 G1 后端实现；P05-ref/P05-PBC 仅是 Torch reference 小输入，不掩盖这些覆盖缺口。P01/P02/P03/P06/P07 本轮仍未运行。无 NVIDIA 对拍 fixture。
