...
P04 自定义算子的 fake/meta、opcheck、gradcheck/gradgradcheck，P07 两卡 LJ ownership/pair 守恒尚待 G1 后端实现；P05-ref/P05-PBC/P05-PBC-LJ-NVE/P05-skin 和 P06-wrapper 仍是 Torch/reference 正确性链，不掩盖 half-list、完整 dynamics API、per-system rebuild 优化、训练 wrapper 混合二阶梯度、更大规模性能和生产 Triton/HIP/cell-list 缺口。P01/P02/P03/P07 本轮仍未运行；P06 仅有上述 partial 证据。无 NVIDIA 对拍 fixture。
