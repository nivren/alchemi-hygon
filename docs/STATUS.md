...
- 当前仍未完成：NVE/FIRE/FIRE2 完整 `BaseDynamics.run()` reference 流程、MACE 接线、DataSink、收敛 Hook、inflight batching 和变胞 stress；下一步是先让 NVE reference 类跑通完整 Batch→model→forces→update 单步，再接固定晶胞 FIRE/FIRE2。
